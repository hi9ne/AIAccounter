...
const translations = {
    ru: {
        ...
        // Goals
        goals: 'Цели',
        savings_goals: 'Накопления на цели',
        active_goals: 'Активные',
        total_saved: 'Накоплено',
        overall_progress: 'Прогресс',
        active: 'Активные',
        achieved: 'Достигнутые',
        no_goals: 'Нет целей',
        create_first_goal: 'Создайте первую цель накопления',
        create_goal: 'Создать цель',
        new_goal: 'Новая цель',
        edit_goal: 'Редактировать цель',
        goal_name: 'Название цели',
        goal_name_placeholder: 'iPhone 16 Pro Max',
        target_amount: 'Целевая сумма',
        initial_amount: 'Начальная сумма',
        deadline: 'Дедлайн',
        icon_and_color: 'Иконка и цвет',
        description: 'Описание',
        add_funds: 'Пополнить',
        history: 'История',
        monthly_target: 'В месяц нужно',
        mark_achieved: 'Цель достигнута',
        ...
        confirm_delete_goal: 'Удалить эту цель?',
    ...
    ky: {
        ...
        // Goals
        goals: 'Максаттар',
        savings_goals: 'Топтоо максаттары',
        active_goals: 'Активдүү',
        total_saved: 'Топтолду',
        overall_progress: 'Прогресс',
        active: 'Активдүү',
        achieved: 'Жетишилди',
        no_goals: 'Максаттар жок',
        create_first_goal: 'Биринчи топтоо максатын түзүңүз',
        create_goal: 'Максат түзүү',
        new_goal: 'Жаңы максат',
        edit_goal: 'Максатты өзгөртүү',
        goal_name: 'Максаттын аты',
        goal_name_placeholder: 'iPhone 16 Pro Max',
        target_amount: 'Максаттык сумма',
        initial_amount: 'Баштапкы сумма',
        deadline: 'Мөөнөт',
        icon_and_color: 'Иконка жана түс',
        description: 'Сүрөттөмө',
        add_funds: 'Толтуруу',
        history: 'Тарых',
        monthly_target: 'Ай сайын керек',
        mark_achieved: 'Жетишилди деп белгилөө',
        goal_completed: 'Максат жетишилди! 🎉',
        goal_created: 'Максат түзүлдү',
        goal_updated: 'Максат жаңыланды',
        goal_deleted: 'Максат өчүрүлдү',
        deposit_success: 'Толтуруу ийгиликтүү',
        confirm_delete_goal: 'Бул максатты өчүрөсүзбү?',
